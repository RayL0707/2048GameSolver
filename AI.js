...
Gist
 ...
 Watch 91
  Star 1,229
  Fork 14,656 ovolve/2048-AI
forked from gabrielecirulli/2048
 Code  Pull requests 0  Projects 0  Wiki  Pulse  Graphs
Branch: master Find file Copy path2048-AI/js/ai.js
e7d09de  on Feb 9, 2015
 ov3y Merge pull request #3 from christianbundy/remove-ai-js-comments
2 contributors @moverlan @christianbundy
RawBlameHistory     
151 lines (134 sloc)  4.25 KB
function AI(grid) {
  this.grid = grid;
}
